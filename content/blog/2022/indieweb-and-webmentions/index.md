...
![Valid `h-card` entry parsed by IndieWebify.me](./images/h-card.png "Valid `h-card` entry parsed by IndieWebify.me")
...
![Valid `h-card` parsed by IndieWebify.me](images/h-entry.png "Valid `h-card` parsed by IndieWebify.me")
