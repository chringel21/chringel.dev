...
{% imagenjk "./images/vector-tile-grid.gif", "Gridded structure of vector tiles" %}
...
{% imagenjk "./images/tileserver-gl.png", "Tileserver GL overview" %}
...
{% imagenjk "./images/osm-bright-gl-style.png", "OSM Bright GL Style" %}
...
{% imagenjk "./images/vector-tiles-google-maps-comparison.png", "OpenStreetMap Vector Tiles compared to Google Maps" %}
